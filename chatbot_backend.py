...
# ✅ PORT SORUNUNU DÜZELTİYORUZ
if __name__ == "__main__":
    import uvicorn
    port = int(os.getenv("PORT", "8000"))  # Render'ın portunu otomatik alacak
    print(f"✅ Server running on port {port}")  # Hata ayıklamak için log ekledik
